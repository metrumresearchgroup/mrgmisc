...
test_that("pad_left works: Left padding works [MRG-PADL-001]", {
...
test_that("pad_left works: Appropriate error message occurs [MRG-PADL-001]", {
  expect_error(pad_left(1, -1), "Number of characters must be positive")
})

test_that("pad_left works: Length of padding characters overrides length of result vector [MRG-PADL-001]", {
