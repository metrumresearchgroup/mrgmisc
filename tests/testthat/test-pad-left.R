...
test_that("left padding works [MRG-MISC-010]", {
...
test_that("Appropriate error message occurs", {
  expect_error(pad_left(1, -1), "Number of characters must be positive")
})

test_that("Length of padding characters overrides length of result vector", {
