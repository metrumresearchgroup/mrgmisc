...
test_that("pad_left expected outcome: left padding works", {
...
test_that("pad_left expected outcome: Appropriate error message occurs", {
  expect_error(pad_left(1, -1), "Number of characters must be positive")
})

test_that("pad_left expected outcome: Length of padding characters overrides length of result vector", {
