test_that("posmat error: Correct error occurs with non-square matrix", {
  expect_error(posmat(matrix(c(10.00006,20.00006,-30, 5, 5, 40),3,2)), "x is not square")
})

test_that("posmat expected output: Correct matrix is produced", {
...
test_that("posmat expected output: Appropriate matrix elements are made", {
