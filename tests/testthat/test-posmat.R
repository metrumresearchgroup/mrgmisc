test_that("Correct error occurs with non-square matrix [MRG-PSMT-002]", {
  expect_error(posmat(matrix(c(10.00006,20.00006,-30, 5, 5, 40),3,2)), "x is not square")
})

test_that("Correct matrix is produced [MRG-PSMT-001]", {
...
test_that("Appropriate matrix elements are made [MRG-PSMT-001]", {
