test_that("correct column names are made", {
...
test_that("Overlapping interval is okay", {
...
test_that("Digits work as intended", {
...
test_that("correct column names are made for Theoph", {
