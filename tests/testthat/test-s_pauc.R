test_that("s_pauc works: Correct column names are made [MRG-SPAC-001]", {
...
test_that("s_pauc works: Overlapping interval is okay [MRG-SPAC-001]", {
...
test_that("s_pauc works: Digits work as intended [MRG-SPAC-001]", {
...
test_that("s_pauc works: Correct column names are made for Theoph [MRG-SPAC-001]", {
