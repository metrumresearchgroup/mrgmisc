test_that("correct column names are made [MRG-SPAC-001]", {
...
test_that("Overlapping interval is okay [MRG-SPAC-001]", {
...
test_that("Digits work as intended [MRG-SPAC-001]", {
...
test_that("correct column names are made for Theoph [MRG-SPAC-001]", {
