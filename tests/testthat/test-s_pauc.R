test_that("s_pauc expected output: Correct column names are made", {
...
test_that("s_pauc expected output: Overlapping interval is okay", {
...
test_that("s_pauc expected output: Digits work as intended", {
...
test_that("s_pauc expected output: Correct column names are made for Theoph", {
