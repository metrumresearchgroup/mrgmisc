...
test_that("resample df properly recombines when it needs to make extra draws [MRG-RESM-001]", {
...
test_that("Appropriate error occurs [MRG-RESM-003]", {
...
test_that("Resampling works with no stratification [MRG-RESM-002]", {
...
test_that("Resampling works with no replacement [MRG-RESM-002]", {
...
test_that("works with n as Null [MRG-RESM-003]", {
