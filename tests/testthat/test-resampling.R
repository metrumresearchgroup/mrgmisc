...
test_that("resample_df works: Resample df properly recombines when it needs to make extra draws [MRG-RESM-001]", {
...
test_that("resample_df errors: Appropriate error occurs [MRG-RESM-003]", {
...
test_that("resample_df special cases: Resampling works with no stratification [MRG-RESM-002]", {
...
test_that("resample_df special cases: Resampling works with no replacement [MRG-RESM-002]", {
...
test_that("resample_df errors: Works with n as Null [MRG-RESM-003]", {
