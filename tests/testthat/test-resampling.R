...
test_that("resample_df properly recombines when it needs to make extra draws [MRG-RESM-001]", {
...
test_that("resample_df unexpected input: Appropriate error occurs [MRG-RESM-003]", {
...
test_that("resample_df expected output: Works with no stratification [MRG-RESM-002]", {
...
test_that("resample_df expected output: Works with no replacement [MRG-RESM-002]", {
...
test_that("resample_df unexpected input: Works with n as Null [MRG-RESM-003]", {
