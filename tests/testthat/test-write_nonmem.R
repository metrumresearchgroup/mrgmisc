...
test_that("File is written to correct location [MRG-WRNM-001]", {
  write_nonmem(Theoph, file = writeTemp)
  expect_true(file.exists(writeTemp))
})

test_that("NA is converted to dots [MRG-WRNM-002]", {
...
test_that("Custom characters for NA [MRG-WRNM-002]", {
  Theoph$Dose[2] = NA_real_
