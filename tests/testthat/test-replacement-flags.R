...
test_that("list elements replaced properly", {
  expect_equal(replace_char_flags(vector, replacementn99), correct_outputn99),
  expect_equal(replace_char_flags(vector, replacementn99,nonflag = NA), correct_outputn99_repNA)
