...
test_that("chunking works: Appropriate output with unique elements [MRG-CHNK-001]", {
...
test_that("chunking works: chunking ignores non-unique elements [MRG-CHNK-001]", {
...
test_that("chunking groups: chunks unique groups as evenly as possible [MRG-CHNK-002]", {
...
test_that("chunking lists: chunks unique elements into a list with their representative values [MRG-CHNK-003]", {
...
test_that("chunking lists: chunks unique elements into equal list if not grp_list [MRG-CHNK-003]", {
...
test_that("chunking lists: chunks grouped elements into ragged arrays [MRG-CHNK-003]", {
...
test_that("ids_per_plot works: Error occurs if input ID's are not vector [MRG-IDPL-001]", {
  expect_error(ids_per_plot(Theoph$Subject[1], id_per_plot = 9), "chunking requires a vector")
})

test_that("ids_per_plot works: IDs are sorted properly [MRG-IDPL-001]", {
