...
test_that("capitalize_names works: Character string returns appropriate error [MRG-CPNM-001]", {
...
test_that("capitalize_names works: Capitalizes tibble names [MRG-CPNM-001]", {
